...
Includes both *perceptual* '[CIE94](http://en.wikipedia.org/wiki/Color_difference#CIE94)+Alpha' by default as well as *actual* 'mathematical absolute' color diff strategies, switchable with a flag.
